...
package spacy.pipeline.textcat;
@:pythonImport("spacy.pipeline.textcat") extern class Textcat_Module {
	...
	**/
	...
	static public var DEFAULT_SINGLE_TEXTCAT_MODEL : Dynamic;
	...
	**/
	static public function make_textcat(nlp:Dynamic, name:Dynamic, model:Dynamic, threshold:Dynamic, scorer:Dynamic):Dynamic;
	static public function make_textcat_scorer():Dynamic;
	/**
	...
	**/
	...
	static public var single_label_bow_config : Dynamic;
	static public var single_label_cnn_config : Dynamic;
	static public var single_label_default_config : Dynamic;
	static public function textcat_score(examples:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
