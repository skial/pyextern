...
@:pythonImport("spacy.pipeline.tok2vec", "Tok2Vec") extern class Tok2Vec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(vocab:Dynamic, model:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a tok2vec component.
		...
		DOCS: https://spacy.io/api/tok2vec#init
	**/
	public function new(vocab:Dynamic, model:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function add_listener(listener:Dynamic, component_name:Dynamic):Dynamic;
	/**
		cfg: object
	**/
	...
	**/
	public function find_listeners(component:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		component. Usually internals.
	**/
	public var listening_components : Dynamic;
	/**
		model: object
	**/
	...
	**/
	public function remove_listener(listener:Dynamic, component_name:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_annotations(docs:Dynamic, tokvecses:Dynamic):Dynamic;
	/**
