...
@:pythonImport("spacy.pipeline.morphologizer", "Morphologizer") extern class Morphologizer {
	static public var POS_FEAT : Dynamic;
	/**
	...
	**/
	...
	/**
		Morphologizer.__init__(self, vocab: Vocab, model: Model, name: str = 'morphologizer', *, overwrite: bool = BACKWARD_OVERWRITE, extend: bool = BACKWARD_EXTEND, scorer: Optional[Callable] = morphologizer_score)
	...
	**/
	@:native("__init__")
	public function ___init__(vocab:Dynamic, model:Dynamic, ?name:Dynamic, ?overwrite:Dynamic, ?extend:Dynamic, ?scorer:Dynamic):Dynamic;
	/**
		Morphologizer.__init__(self, vocab: Vocab, model: Model, name: str = 'morphologizer', *, overwrite: bool = BACKWARD_OVERWRITE, extend: bool = BACKWARD_EXTEND, scorer: Optional[Callable] = morphologizer_score)
		Initialize a morphologizer.
	...
	**/
	public function new(vocab:Dynamic, model:Dynamic, ?name:Dynamic, ?overwrite:Dynamic, ?extend:Dynamic, ?scorer:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		Morphologizer.add_label(self, label)
	...
	**/
	...
	/**
		Morphologizer.get_loss(self, examples, scores)
	...
	**/
	...
	/**
		Morphologizer.initialize(self, get_examples, *, nlp=None, labels=None)
	...
	**/
	...
	/**
		Morphologizer.label_data(self) -> Dict[str, Dict[str, Union[str, float, int, None]]]
		A dictionary with all labels data.
	**/
	public var label_data : Dynamic;
	/**
		Morphologizer.labels(self)
	...
	**/
	...
	/**
		Morphologizer.set_annotations(self, docs, batch_tag_ids)
