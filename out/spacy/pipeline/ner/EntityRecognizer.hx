...
@:pythonImport("spacy.pipeline.ner", "EntityRecognizer") extern class EntityRecognizer {
	/**
		BiluoPushDown(*args, **kwargs)
	**/
	...
	**/
	...
	/**
		EntityRecognizer.__reduce_cython__(self)
	**/
	...
	**/
	...
	/**
		EntityRecognizer.__setstate_cython__(self, __pyx_state)
	**/
	...
	**/
	...
	/**
		EntityRecognizer.add_multitask_objective(self, mt_component)
	...
	**/
	...
	/**
		EntityRecognizer.init_multitask_objectives(self, get_examples, nlp=None, **cfg)
