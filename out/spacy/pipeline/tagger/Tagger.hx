...
@:pythonImport("spacy.pipeline.tagger", "Tagger") extern class Tagger {
	/**
	...
	**/
	...
	/**
		Tagger.__init__(self, vocab, model, name='tagger', *, overwrite=BACKWARD_OVERWRITE, scorer=tagger_score, neg_prefix='!')
	...
	**/
	@:native("__init__")
	public function ___init__(vocab:Dynamic, model:Dynamic, ?name:Dynamic, ?overwrite:Dynamic, ?scorer:Dynamic, ?neg_prefix:Dynamic):Dynamic;
	/**
		Tagger.__init__(self, vocab, model, name='tagger', *, overwrite=BACKWARD_OVERWRITE, scorer=tagger_score, neg_prefix='!')
		Initialize a part-of-speech tagger.
	...
	**/
	public function new(vocab:Dynamic, model:Dynamic, ?name:Dynamic, ?overwrite:Dynamic, ?scorer:Dynamic, ?neg_prefix:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		Tagger.get_loss(self, examples, scores)
	...
	**/
	...
	/**
		Tagger.initialize(self, get_examples, *, nlp=None, labels=None)
	...
	**/
	...
	/**
		Tagger.set_annotations(self, docs, batch_tag_ids)
