...
@:pythonImport("spacy.pipeline.trainable_pipe") extern class Trainable_pipe_Module {
	/**
	...
	**/
	...
	/**
		__pyx_unpickle_TrainablePipe(__pyx_type, long __pyx_checksum, __pyx_state)
	**/
	static public function __pyx_unpickle_TrainablePipe(args:haxe.extern.Rest<Dynamic>):Dynamic;
