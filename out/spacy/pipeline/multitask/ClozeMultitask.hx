...
@:pythonImport("spacy.pipeline.multitask", "ClozeMultitask") extern class ClozeMultitask {
	/**
	...
	**/
	...
	/**
		ClozeMultitask.__init__(self, vocab, model, **cfg)
	**/
	@:native("__init__")
	public function ___init__(vocab:Dynamic, model:Dynamic, ?cfg:python.KwArgs<Dynamic>):Dynamic;
	/**
		ClozeMultitask.__init__(self, vocab, model, **cfg)
	**/
	public function new(vocab:Dynamic, model:Dynamic, ?cfg:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		ClozeMultitask.add_label(self, label)
	**/
	...
	**/
	...
	/**
		ClozeMultitask.get_loss(self, examples, vectors, prediction)
	**/
	public function get_loss(examples:Dynamic, vectors:Dynamic, prediction:Dynamic):Dynamic;
	public var hide_labels : Dynamic;
	/**
		ClozeMultitask.initialize(self, get_examples, nlp=None)
	**/
	...
	**/
	...
	/**
		ClozeMultitask.predict(self, docs)
	**/
	public function predict(docs:Dynamic):Dynamic;
	/**
		ClozeMultitask.rehearse(self, examples, drop=0., sgd=None, losses=None)
	**/
	...
	**/
	...
	/**
		ClozeMultitask.set_annotations(self, docs, dep_ids)
	**/
	...
	**/
	...
	/**
		ClozeMultitask.update(self, examples, *, drop=0., sgd=None, losses=None)
	**/
