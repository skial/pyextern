...
@:pythonImport("spacy.displacy.render", "EntityRenderer") extern class EntityRenderer {
	...
	**/
	public function render_ents(text:Dynamic, spans:Dynamic, title:Dynamic):Dynamic;
