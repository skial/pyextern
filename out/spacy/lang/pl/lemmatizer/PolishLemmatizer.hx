...
package spacy.lang.pl.lemmatizer;
@:pythonImport("spacy.lang.pl.lemmatizer", "PolishLemmatizer") extern class PolishLemmatizer {
	/**
	...
	**/
	...
	public function lemmatize_verb(string:Dynamic, morphology:Dynamic, lookup_table:Dynamic):Dynamic;
	/**
