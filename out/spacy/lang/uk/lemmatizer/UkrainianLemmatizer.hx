...
package spacy.lang.uk.lemmatizer;
@:pythonImport("spacy.lang.uk.lemmatizer", "UkrainianLemmatizer") extern class UkrainianLemmatizer {
	/**
	...
	**/
	...
	public function pymorphy2_lemmatize(token:Dynamic):Dynamic;
	public function pymorphy2_lookup_lemmatize(token:Dynamic):Dynamic;
	/**
