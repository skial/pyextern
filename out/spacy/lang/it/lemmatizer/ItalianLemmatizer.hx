...
package spacy.lang.it.lemmatizer;
@:pythonImport("spacy.lang.it.lemmatizer", "ItalianLemmatizer") extern class ItalianLemmatizer {
	/**
	...
	**/
	...
	public function lemmatize_adj(string:Dynamic, morphology:Dynamic, lookup_table:Dynamic):Dynamic;
	public function lemmatize_adp(string:Dynamic, morphology:Dynamic, lookup_table:Dynamic):Dynamic;
	public function lemmatize_det(string:Dynamic, morphology:Dynamic, lookup_table:Dynamic):Dynamic;
	public function lemmatize_noun(string:Dynamic, morphology:Dynamic, lookup_table:Dynamic):Dynamic;
	public function lemmatize_pron(string:Dynamic, morphology:Dynamic, lookup_table:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function pos_lookup_lemmatize(token:Dynamic):Dynamic;
	/**
