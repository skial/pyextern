...
@:pythonImport("spacy.lang.ja", "DetailedToken") extern class DetailedToken {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DetailedToken(surface, tag, inf, lemma, norm, reading, sub_tokens)
	**/
	static public function __new__(_cls:Dynamic, surface:Dynamic, tag:Dynamic, inf:Dynamic, lemma:Dynamic, norm:Dynamic, reading:Dynamic, sub_tokens:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new DetailedToken object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new DetailedToken object replacing specified fields with new values
	**/
	...
	**/
	public var reading : Dynamic;
	/**
		Alias for field number 6
	**/
	public var sub_tokens : Dynamic;
	/**
