...
package spacy.util;
@:pythonImport("spacy.util", "SimpleFrozenList") extern class SimpleFrozenList {
	/**
		Return self+value.
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(?args:python.VarArgs<Dynamic>, ?error:Dynamic):Dynamic;
	/**
		Initialize the frozen list.
		
		error (str): The error message when user tries to mutate the list.
	**/
	public function new(?args:python.VarArgs<Dynamic>, ?error:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		Reverse *IN PLACE*.
	**/
	public function reverse(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
