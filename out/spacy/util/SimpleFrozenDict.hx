...
package spacy.util;
@:pythonImport("spacy.util", "SimpleFrozenDict") extern class SimpleFrozenDict {
	...
	**/
	@:native("__init__")
	public function ___init__(?args:python.VarArgs<Dynamic>, ?error:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize the frozen dict. Can be initialized with pre-defined
		values.
		...
		error (str): The error message when user tries to assign to dict.
	**/
	public function new(?args:python.VarArgs<Dynamic>, ?error:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
