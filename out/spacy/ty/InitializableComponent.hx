...
package spacy.ty;
@:pythonImport("spacy.ty", "InitializableComponent") extern class InitializableComponent {
	...
	**/
	...
	public function initialize(get_examples:Dynamic, nlp:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
}