...
@:pythonImport("spacy.errors", "MatchPatternError") extern class MatchPatternError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(key:Dynamic, errors:Dynamic):Dynamic;
	/**
		Custom error for validating match patterns.
		...
		errors (dict): Validation errors (sequence of strings) mapped to pattern
		    ID, i.e. the index of the added pattern.
	**/
	public function new(key:Dynamic, errors:Dynamic):Void;
	/**
