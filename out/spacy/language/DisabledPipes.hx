...
@:pythonImport("spacy.language", "DisabledPipes") extern class DisabledPipes {
	/**
		Return self+value.
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(nlp:Dynamic, names:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nlp:Dynamic, names:Dynamic):Void;
	/**
