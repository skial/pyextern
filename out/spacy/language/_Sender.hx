...
@:pythonImport("spacy.language", "_Sender") extern class _Sender {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, queues:Dynamic, chunk_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, queues:Dynamic, chunk_size:Dynamic):Void;
	/**
